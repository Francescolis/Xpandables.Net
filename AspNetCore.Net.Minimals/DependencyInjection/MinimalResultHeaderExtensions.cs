...
public static class MinimalResultHeaderExtensions
{
    extension(IServiceCollection services)
    {
        ...
        /// </summary>
        /// <remarks>This method registers <see cref="ExecutionResultHeaderWriter"/> as the implementation
        ...
        public IServiceCollection AddXExecutionResultHeaderWriter()
            => services.AddXExecutionResultHeaderWriter<ExecutionResultHeaderWriter>();

        /// <summary>
        /// Registers a scoped implementation of <see cref="IExecutionResultHeaderWriter"/> using the specified type in
        ...
        /// <typeparam name="TExecutionResultHeaderWriter">The type that implements <see cref="IExecutionResultHeaderWriter"/> and will be registered as a scoped
        ...
        public IServiceCollection AddXExecutionResultHeaderWriter<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TExecutionResultHeaderWriter>()
            where TExecutionResultHeaderWriter : class, IExecutionResultHeaderWriter
        {
            ArgumentNullException.ThrowIfNull(services);
            services.AddScoped<IExecutionResultHeaderWriter, TExecutionResultHeaderWriter>();
            return services;
        }
    }
