...
using BankAccounts.Domain.Features.OperationAccount;

namespace BankAccounts.Api.Features;

[System.Diagnostics.CodeAnalysis.SuppressMessage("Maintainability", "CA1515:Consider making public types internal", Justification = "<Pending>")]
public sealed class AccountOperationEndpoint : IMinimalEndpointRoute
{
	public void AddRoutes(MinimalRouteBuilder app)
	{
		...
		app.MapGet("/bank-accounts/{accountId}/operations",
			...
			.Produces200OK<IAsyncPagedEnumerable<AccountOperationResult>>();
	}
}
