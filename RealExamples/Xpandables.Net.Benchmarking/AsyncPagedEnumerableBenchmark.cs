...
public class AsyncPagedEnumerableBenchmark
{
	...
	public async Task<long> SerializeAsync_IAsyncEnumerableAsync()
	{
		List<SampleData> data = GetDataSetBySize();
	...
	public async Task<long> SerializeAsync_IAsyncPagedEnumerableAsync()
	{
		List<SampleData> data = GetDataSetBySize();
		await using MemoryStream stream = new();
	...
	public async Task<int> DeserializeAsync_IAsyncEnumerable_FromHttpContentAsync()
	{
	...
	public async Task<int> DeserializeAsync_IAsyncPagedEnumerable_FromHttpContentAsync()
	{
