...
public sealed class ElementCollectionTests
{
	...
	{
		// Arrange
		ElementEntry[] entries = new[] { new ElementEntry("key1", "value1"), new ElementEntry("key2", "value2") };
	...
	{
		// Arrange
		var dict = new Dictionary<string, StringValues> { ["name"] = "John", ["age"] = "30" };
	...
	public void WhenAddingElementEntryThenShouldBeInCollection()
	{
		// Arrange
		var collection = new ElementCollection();
		var entry = new ElementEntry("key", new[] { "value1", "value2" });
	...
	public void WhenAddingRangeFromStringValuesDictionaryThenAllShouldBeAdded()
	{
		...
		{
			["key1"] = new StringValues(["a", "b"]), ["key2"] = new StringValues(["c", "d"])
		};
	...
	public void WhenAddingRangeOfEntriesThenAllShouldBeAdded()
	{
		...
		{
			new ElementEntry("key1", "value1"), new ElementEntry("key2", "value2"),
	...
	{
		// Arrange
		var collection = new ElementCollection { { "first", "1" }, { "second", "2" }, { "third", "3" } };
	...
	{
		// Arrange
		var collection = new ElementCollection { { "key1", "value1" }, { "key2", "value2" } };
	...
	{
		// Arrange
		var left = new ElementCollection { { "key1", "value1" }, { "key2", "value2" }, { "key3", "value3" } };
	...
	{
		// Arrange
		var collection = new ElementCollection { { "key1", "value1" }, { "key2", "value2", "value3" } };
	...
	{
		// Arrange
		var collection = new ElementCollection { { "key1", "value1" }, { "key2", "value2" }, { "key3", "value3" } };
	...
	{
		// Arrange
		var collection = new ElementCollection { { "name", "John" }, { "email", "john@example.com" } };
	...
	{
		// Arrange
		var collection = new ElementCollection { { "name", "John" }, { "age", "30" } };
	...
	{
		// Arrange
		var original = new ElementCollection { { "field1", "value1" }, { "field2", "value2", "value3" } };

		string json = JsonSerializer.Serialize(original, ElementCollectionContext.Default.ElementCollection);

		// Act
		ElementCollection deserialized =
			JsonSerializer.Deserialize(json, ElementCollectionContext.Default.ElementCollection);
	...
	public void WhenBuildingQueryParametersThenShouldAccumulateValues()
	{
		...
		var queryParams = new ElementCollection
		{
			...
			{ "category", "electronics" }, { "category", "books" }, { "sort", "price" }, { "page", "1" }
		};
	...
	public void WhenFilteringErrorsThenShouldWorkCorrectly()
	{
		...
		// Act
		IEnumerable<ElementEntry> criticalOnly =
			errors.Where(e => e.Key.StartsWith("critical", StringComparison.Ordinal));
