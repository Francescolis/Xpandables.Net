...
public sealed class ObjectExtensionsTests
{
	...
	public void WhenConvertingToNullableIntThenShouldReturnValue()
	{
		...
		// Act
		int? result = obj.ChangeTypeNullable<int?>();
	...
	public void WhenConvertingDoubleToDecimalThenShouldConvert()
	{
		...
		// Act
		decimal result = obj.ChangeTypeNullable<decimal>();
	...
	public void WhenConvertingWithCultureInfoThenShouldUseCulture()
	{
		...
		// Act
		decimal result = obj.ChangeTypeNullable<decimal>(culture);
	...
	public void WhenConvertingToNullableDateTimeThenShouldConvert()
	{
		...
		// Act
		DateTime? result = obj.ChangeTypeNullable<DateTime?>();
	...
	public void WhenConvertingToNonNullableTypeThenShouldConvert()
	{
		...
		// Act
		bool result = obj.ChangeTypeNullable<bool>();
	...
	public void WhenCastingToCorrectTypeThenShouldReturnInstance()
	{
		...
		// Act
		string? result = ObjectExtensions.As<string>(obj);
	...
	public void WhenCastingToIncorrectTypeThenShouldReturnNull()
	{
		...
		// Act
		List<int>? result = ObjectExtensions.As<List<int>>(obj);
	...
	public void WhenCastingToBaseTypeThenShouldSucceed()
	{
		...
		// Act
		BaseClass? result = ObjectExtensions.As<BaseClass>(obj);
	...
	public void WhenCastingToInterfaceThenShouldSucceed()
	{
		...
		// Act
		ITestInterface? result = ObjectExtensions.As<ITestInterface>(obj);
	...
	public void WhenCastingWithTemplateThenShouldReturnCorrectType()
	{
		...
		// Act
		DerivedClass? result = obj.As(template);
	...
	public void WhenCastingWithAsRequiredToCorrectTypeThenShouldReturnInstance()
	{
		...
		// Act
		string result = obj.AsRequired<string>();
	...
	public void WhenCastingNullWithAsRequiredThenShouldThrowArgumentNullException()
	{
		...
		// Act
		Func<string> act = () => obj.AsRequired<string>();
	...
	public void WhenCastingToIncorrectTypeWithAsRequiredThenShouldThrowInvalidCastException()
	{
		...
		// Act
		Func<List<int>> act = () => obj.AsRequired<List<int>>();
	...
	public void WhenCastingToBaseTypeWithAsRequiredThenShouldSucceed()
	{
		...
		// Act
		BaseClass result = obj.AsRequired<BaseClass>();
	...
	public void WhenConditionIsTrueThenActionShouldBeExecuted()
	{
		...
		// Act
		List<int> result = list.When(true, l =>
		{
			l.Add(4);
			executed = true;
		});
	...
	public void WhenConditionIsFalseThenActionShouldNotBeExecuted()
	{
		...
		// Act
		List<int> result = list.When(false, l =>
		{
			l.Add(4);
			executed = true;
		});
	...
	public void WhenConditionIsTrueThenShouldReturnOriginalObject()
	{
		...
		// Act
		StringBuilder result = original.When(true, sb => sb.Append(" modified"));
	...
	public void WhenActionIsNullThenShouldThrowArgumentNullException()
	{
		...
		// Act
		Func<object> act = () => obj.When(true, (Action<object>)null!);
	...
	public void WhenObjectIsNullThenShouldThrowArgumentNullException()
	{
		...
		// Act
		Func<string> act = () => obj!.When(true, _ => { });
	...
	public void WhenConditionIsTrueThenFuncShouldBeExecuted()
	{
		...
		// Act
		string result = original.When(true, s => s.ToUpperInvariant());
	...
	public void WhenConditionIsFalseThenFuncShouldNotBeExecutedAndReturnOriginal()
	{
		...
		// Act
		string result = original.When(false, s => s.ToUpperInvariant());
	...
	public void WhenFuncIsNullThenShouldThrowArgumentNullException()
	{
		...
		// Act
		Func<string> act = () => obj.When(true, (Func<string, string>)null!);
	...
	public void WhenTransformingObjectThenShouldReturnTransformedResult()
	{
		...
		// Act
		TestOrder result = order.When(order.Total > 50,
	...
	public void WhenProcessingApiResponseThenShouldHandleTypeConversions()
	{
		...
		Dictionary<string, object>? dict = ObjectExtensions.As<Dictionary<string, object>>(response);

		// Act
		int id = dict!["id"].ChangeTypeNullable<int>();
		decimal amount = dict["amount"].ChangeTypeNullable<decimal>();
		bool active = dict["active"].ChangeTypeNullable<bool>();
	...
	public void WhenHandlingUnknownObjectTypeThenAsShouldReturnNull()
	{
		...
		// Act
		Customer? asCustomer = ObjectExtensions.As<Customer>(unknownData);
		Order? asOrder = ObjectExtensions.As<Order>(unknownData);
	...
	public void WhenConvertingDatabaseValuesThenShouldHandleNullables()
	{
		...
		// Act
		string? name = rowValues[0]?.ChangeTypeNullable<string>();
		int? age = rowValues[1]?.ChangeTypeNullable<int?>();
		string? middleName = rowValues[2] == DBNull.Value ? null : rowValues[2]?.ChangeTypeNullable<string>();
		DateTime? date = rowValues[3]?.ChangeTypeNullable<DateTime?>();
	...
	public void WhenConvertingEmptyStringToNullableIntThenShouldThrow()
	{
		...
		// Act
		Func<int?> act = () => obj.ChangeTypeNullable<int?>();
	...
	public void WhenConvertingValidGuidStringThenShouldConvert()
	{
		...
		// Act
		Guid? result = obj.ChangeTypeNullable<Guid?>();
