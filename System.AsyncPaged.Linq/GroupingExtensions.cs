...
public static class GroupingExtensions
{
	...
	public static IAsyncPagedEnumerable<IGrouping<TKey, TSource>> GroupByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector)
		where TKey : notnull
	{
	...
	/// <returns>An <see cref="IAsyncPagedEnumerable{T}"/> where each element is an <see cref="IGrouping{TKey, TSource}"/> object containing a sequence of objects and a key.</returns>
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or key selector is null.</exception>
	public static IAsyncPagedEnumerable<IGrouping<TKey, TSource>> GroupByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer)
		where TKey : notnull
	{
	...
	public static IAsyncPagedEnumerable<IGrouping<TKey, TElement>> GroupByPaged<TSource, TKey, TElement>(this IAsyncPagedEnumerable<TSource> source,
	...
	public static IAsyncPagedEnumerable<TResult> GroupByPaged<TSource, TKey, TResult>(this IAsyncPagedEnumerable<TSource> source,
		Func<TSource, TKey> keySelector,
