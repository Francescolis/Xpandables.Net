...
public static class JoinExtensions
{
	...
	public static IAsyncPagedEnumerable<TResult> JoinPaged<TSource, TInner, TKey, TResult>(this IAsyncPagedEnumerable<TSource> source,
	...
	/// <exception cref="ArgumentNullException">Thrown when any of the parameters is null.</exception>
	public static IAsyncPagedEnumerable<TResult> GroupJoinPaged<TSource, TInner, TKey, TResult>(this IAsyncPagedEnumerable<TSource> source,
		IAsyncEnumerable<TInner> inner,
		Func<TSource, TKey> outerKeySelector,
		Func<TInner, TKey> innerKeySelector,
