...
public static class OrderingExtensions
{
	...
	public static IAsyncPagedEnumerable<TSource> OrderByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector)
	{
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> OrderByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey>? comparer)
	{
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or key selector is null.</exception>
	public static IAsyncPagedEnumerable<TSource> OrderByDescendingPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector)
	{
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> OrderByDescendingPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey>? comparer)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(keySelector);
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> ReversePaged<TSource>(this IAsyncPagedEnumerable<TSource> source)
	{
		ArgumentNullException.ThrowIfNull(source);
