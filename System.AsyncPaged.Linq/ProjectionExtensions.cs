...
public static class ProjectionExtensions
{
	...
	public static IAsyncPagedEnumerable<TResult> SelectPaged<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TResult> selector)
	{
	...
	public static IAsyncPagedEnumerable<TResult> SelectPaged<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, int, TResult> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
	...
	public static IAsyncPagedEnumerable<TResult> SelectPagedAsync<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, ValueTask<TResult>> selectorAsync)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	public static IAsyncPagedEnumerable<TResult> SelectPagedAsync<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, CancellationToken, ValueTask<TResult>> selectorAsync)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selectorAsync);
