...
public static class SetExtensions
{
	...
	public static IAsyncPagedEnumerable<TSource> UnionPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other)
	{
	...
	/// <returns>An async paged enumerable that contains the elements from both input sequences, excluding duplicates.</returns>
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> UnionPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other, IEqualityComparer<TSource>? comparer)
	{
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> IntersectPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other)
	{
	...
	/// <returns>An async paged enumerable that contains the elements that form the set intersection of two sequences.</returns>
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> IntersectPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other, IEqualityComparer<TSource>? comparer)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(other);
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> ExceptPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other)
	{
	...
	/// <returns>An async paged enumerable that contains the set difference of the elements of two sequences.</returns>
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> ExceptPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other, IEqualityComparer<TSource>? comparer)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(other);
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> ConcatPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TSource> other)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(other);
	...
	public static IAsyncPagedEnumerable<TSource> PrependPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, TSource element)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource> AppendPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, TSource element)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// </summary>
	/// <typeparam name="TSource">The type of the elements of the first input sequence.</typeparam>
	...
	public static IAsyncPagedEnumerable<TResult> ZipPaged<TSource, TOther, TResult>(this IAsyncPagedEnumerable<TSource> source,
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence or the other sequence is null.</exception>
	public static IAsyncPagedEnumerable<(TSource First, TOther Second)> ZipPaged<TSource, TOther>(this IAsyncPagedEnumerable<TSource> source, IAsyncEnumerable<TOther> other)
	{
	...
	/// <exception cref="ArgumentNullException">Thrown when the current sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource?> DefaultIfEmptyPaged<TSource>(this IAsyncPagedEnumerable<TSource> source)
	{
	...
	/// <returns>An async paged enumerable that contains the default value if the source sequence is empty; otherwise, the source sequence itself.</returns>
	/// <exception cref="ArgumentNullException">Thrown when the current sequence is null.</exception>
	public static IAsyncPagedEnumerable<TSource?> DefaultIfEmptyPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, TSource? defaultValue)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> DistinctPaged<TSource>(this IAsyncPagedEnumerable<TSource> source)
	{
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> DistinctPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, IEqualityComparer<TSource>? comparer)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> DistinctByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector)
	{
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource> DistinctByPaged<TSource, TKey>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TResult> CastPaged<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// </para>
	/// </remarks>
	public static IAsyncPagedEnumerable<TResult> OfTypePaged<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source)
	{
		ArgumentNullException.ThrowIfNull(source);
