...
public static class WindowingExtensions
{
	...
	/// </remarks>
	public static IAsyncPagedEnumerable<TSource[]> WindowPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, int windowSize)
	{
	...
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="windowSize"/> is less than 1.</exception>
	public static IAsyncPagedEnumerable<int> WindowedSumPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, int> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or selector is null.</exception>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="windowSize"/> is less than 1.</exception>
	public static IAsyncPagedEnumerable<long> WindowedSumPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, long> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
		ArgumentOutOfRangeException.ThrowIfLessThan(windowSize, 1);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or selector is null.</exception>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="windowSize"/> is less than 1.</exception>
	public static IAsyncPagedEnumerable<double> WindowedSumPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, double> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
		ArgumentOutOfRangeException.ThrowIfLessThan(windowSize, 1);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or selector is null.</exception>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="windowSize"/> is less than 1.</exception>
	public static IAsyncPagedEnumerable<double> WindowedAveragePaged<TSource>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, double> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
		ArgumentOutOfRangeException.ThrowIfLessThan(windowSize, 1);
	...
	/// </remarks>
	public static IAsyncPagedEnumerable<TValue> WindowedMinPaged<TSource, TValue>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, TValue> selector)
	...
	/// This method uses a monotonic deque algorithm for O(n) performance instead of O(n�).
	/// </remarks>
	public static IAsyncPagedEnumerable<TValue> WindowedMaxPaged<TSource, TValue>(this IAsyncPagedEnumerable<TSource> source, int windowSize, Func<TSource, TValue> selector)
		where TValue : IComparable<TValue>
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence is null.</exception>
	public static IAsyncPagedEnumerable<(TSource Previous, TSource Current)> PairwisePaged<TSource>(this IAsyncPagedEnumerable<TSource> source)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or selector is null.</exception>
	public static IAsyncPagedEnumerable<TResult> PairwisePaged<TSource, TResult>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TSource, TResult> selector)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(selector);
	...
	public static IAsyncPagedEnumerable<TAccumulate> ScanPaged<TSource, TAccumulate>(this IAsyncPagedEnumerable<TSource> source, TAccumulate seed, Func<TAccumulate, TSource, TAccumulate> func)
	{
		ArgumentNullException.ThrowIfNull(source);
	...
	/// <exception cref="ArgumentNullException">Thrown when the source sequence or func is null.</exception>
	public static IAsyncPagedEnumerable<TSource> ScanPaged<TSource>(this IAsyncPagedEnumerable<TSource> source, Func<TSource, TSource, TSource> func)
	{
		ArgumentNullException.ThrowIfNull(source);
		ArgumentNullException.ThrowIfNull(func);
