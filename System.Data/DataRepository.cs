...
public class DataRepository<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] TData>(
	IDataConnectionScope connectionScope, IDataSqlBuilder sqlBuilder, IDataSqlMapper sqlMapper,
	...
	where TData : class
{
	...
	private readonly IDataConnectionScope _connectionScope = connectionScope ?? throw new ArgumentNullException(nameof(connectionScope));
...
#pragma warning restore CA1033 // Interface methods should be callable by child types
		...
		[EnumeratorCancellation] CancellationToken cancellationToken = default)
	{
		...
		DbCommand command = _connectionScope.CreateCommand(queryResult);
