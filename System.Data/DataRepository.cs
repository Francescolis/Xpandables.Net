...
public class DataRepository<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)] TData>(
    IDbConnectionScope connectionScope, ISqlBuilder sqlBuilder, ISqlMapper sqlMapper)
    ...
    where TData : class
{
    ...
    private readonly ISqlBuilder _sqlBuilder = sqlBuilder ?? throw new ArgumentNullException(nameof(sqlBuilder));
    private readonly ISqlMapper _sqlMapper = sqlMapper ?? throw new ArgumentNullException(nameof(sqlMapper));
