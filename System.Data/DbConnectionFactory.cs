...
/// <summary>
/// Provides a default implementation of <see cref="IDbConnectionFactory"/> that creates 
...
/// </exception>
public sealed class DbConnectionFactory(string providerInvariantName, string connectionString) : IDbConnectionFactory
{
