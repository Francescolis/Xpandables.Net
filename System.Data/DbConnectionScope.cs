...
/// <summary>
/// Provides a default implementation of <see cref="IDbConnectionScope"/> that manages the 
...
public sealed class DbConnectionScope(DbConnection connection) : IDbConnectionScope
{
...
/// <summary>
/// Provides a default implementation of <see cref="IDbConnectionScopeFactory"/> that creates 
/// <see cref="DbConnectionScope"/> instances using an <see cref="IDbConnectionFactory"/>.
/// </summary>
/// <param name="connectionFactory">The factory used to create database connections.</param>
/// <exception cref="ArgumentNullException">Thrown when <paramref name="connectionFactory"/> is null.</exception>
public sealed class DbConnectionScopeFactory(IDbConnectionFactory connectionFactory) : IDbConnectionScopeFactory
{
    private readonly IDbConnectionFactory _connectionFactory = connectionFactory
        ?? throw new ArgumentNullException(nameof(connectionFactory));

    /// <inheritdoc />
    public async Task<IDbConnectionScope> CreateScopeAsync(CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public IDbConnectionScope CreateScope()
    {
