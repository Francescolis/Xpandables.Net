...
public interface IDbConnectionScopeFactoryProvider
{
    /// <summary>
    /// Gets the scope factory for the specified connection name.
    /// </summary>
    /// <param name="name">The name of the connection.</param>
    IDbConnectionScopeFactory GetScopeFactory(string name);
    ...
    IDbConnectionScopeFactory GetScopeFactory(string name, string providerInvariantName);
    ...
    Task<IDbConnectionScope> CreateScopeAsync(string name, CancellationToken cancellationToken = default);
    ...
    /// <param name="providerInvariantName">The provider invariant name override.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    Task<IDbConnectionScope> CreateScopeAsync(string name, string providerInvariantName, CancellationToken cancellationToken = default);

    /// <summary>
    /// Creates a new scope for the specified connection name.
    /// </summary>
    /// <param name="name">The name of the connection.</param>
    IDbConnectionScope CreateScope(string name);
    ...
    /// <param name="name">The name of the connection.</param>
    /// <param name="providerInvariantName">The provider invariant name override.</param>
    IDbConnectionScope CreateScope(string name, string providerInvariantName);
}
