...
public static class IDataExtensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddXDbConnectionMsSqlServer(string connectionString)
        {
            ArgumentNullException.ThrowIfNull(services);
            ArgumentException.ThrowIfNullOrWhiteSpace(connectionString);
            services.TryAddSingleton<IDbConnectionFactory>(
                _ => new DbConnectionFactory(DbProviders.MsSqlServer.InvariantName, connectionString));
            return services;
        }
        ...
        /// whitespace.</param>
        /// <returns>The updated IServiceCollection instance, enabling method chaining.</returns>
        public IServiceCollection AddXDbConnectionPostgreSql(string connectionString)
        {
            ArgumentNullException.ThrowIfNull(services);
            ArgumentException.ThrowIfNullOrWhiteSpace(connectionString);
            services.TryAddSingleton<IDbConnectionFactory>(
                _ => new DbConnectionFactory(DbProviders.PostgreSql.InvariantName, connectionString));
            return services;
        }
        ...
        public IServiceCollection AddXDbConnectionMySql(string connectionString)
        {
            ArgumentNullException.ThrowIfNull(services);
            ArgumentException.ThrowIfNullOrWhiteSpace(connectionString);
            services.TryAddSingleton<IDbConnectionFactory>(
                _ => new DbConnectionFactory(DbProviders.MySql.InvariantName, connectionString));
            return services;
        }
        ...
        public IServiceCollection AddXDbConnectionFactory(string providerInvariantName, string connectionString)
        {
            ArgumentNullException.ThrowIfNull(services);
            ...
            services.TryAddSingleton<IDbConnectionFactory>(
                _ => new DbConnectionFactory(providerInvariantName, connectionString));
        ...
        /// <returns>The <see cref="IServiceCollection"/> instance for chaining.</returns>
        public IServiceCollection AddXDbConnectionFactory<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TFactory>()
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/> instance for chaining.</returns>
        public IServiceCollection AddXDbConnectionScopeFactory()
        {
            ArgumentNullException.ThrowIfNull(services);
            return services.AddSingleton<IDbConnectionScopeFactory, DbConnectionScopeFactory>();
        }
        ...
        /// </summary>
        /// <returns>The <see cref="IServiceCollection"/> instance for chaining.</returns>
        public IServiceCollection AddXDbConnectionScope()
        {
            ArgumentNullException.ThrowIfNull(services);
            return services.AddScoped<IDbConnectionScope>(sp =>
                sp.GetRequiredService<IDbConnectionScopeFactory>().CreateScope());
        }
        ...
        public IServiceCollection AddXSlqBuilderMsSqlServer()
        {
            ArgumentNullException.ThrowIfNull(services);
            return services.AddSingleton<ISqlBuilder, SqlServerSqlBuilder>();
        }
        ...
        /// <returns>The IServiceCollection instance that can be used to configure additional services.</returns>
        public IServiceCollection AddXSlqBuilderPostgreSql()
        {
            ArgumentNullException.ThrowIfNull(services);
        ...
        /// <returns>The IServiceCollection instance that can be used to configure additional services.</returns>
        public IServiceCollection AddXSlqBuilderMySql()
        {
            ArgumentNullException.ThrowIfNull(services);
