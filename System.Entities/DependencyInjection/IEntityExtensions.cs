...
public static class IEntityExtensions
{
	...
	public static IServiceCollection AddXEntityUnitOfWork<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TUnitOfWork>(this IServiceCollection services)
	...
	public static IServiceCollection AddXEntityUnitOfWorkKeyed<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TUnitOfWork>(this IServiceCollection services, string key)
		where TUnitOfWork : class, IEntityUnitOfWork
	{
	...
	public static IServiceCollection AddXEntityUnitOfWork<TInterface, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation>(this IServiceCollection services)
	...
	/// <returns>The IServiceCollection instance for chaining additional service registrations.</returns>
	public static IServiceCollection AddXEntityUnitOfWorkKeyed<TInterface, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation>(this IServiceCollection services, string key)
		where TInterface : class, IEntityUnitOfWork
		where TImplementation : class, TInterface
	{
		ArgumentNullException.ThrowIfNull(key);
	...
	public static IServiceCollection AddXEntityRepository<TRepository, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TImplementation>(this IServiceCollection services,
	...
	public static IServiceCollection AddXEntityRepositories(this IServiceCollection services,
