...
public sealed class EventConverterDomain(ICacheTypeResolver typeResolver, IJsonSerializerContext converterContext) : IEventConverter<DataEventDomain, IDomainEvent>
{
