...
public sealed class EventConverterFactory : IEventConverterFactory
{
    ...
    public EventConverterFactory(
        ...
        IEventConverter<DataEventDomain, IDomainEvent> domainConverter,
        IEventConverter<DataEventOutbox, IIntegrationEvent> integrationConverter,
        IEventConverter<DataEventInbox, IIntegrationEvent> inboxConverter,
        IEventConverter<DataEventSnapshot, ISnapshotEvent> snapshotConverter)
    {
        ...
        {
            [typeof(DataEventDomain)] = domainConverter,
            [typeof(DataEventOutbox)] = integrationConverter,
            [typeof(DataEventInbox)] = inboxConverter,
            [typeof(DataEventSnapshot)] = snapshotConverter
        }.ToFrozenDictionary();
    }
    ...
    public IEventConverter<TEntitySnapshotEvent, ISnapshotEvent> GetSnapshotEventConverter<TEntitySnapshotEvent>()
        where TEntitySnapshotEvent : class, IDataEventSnapshot
    {
