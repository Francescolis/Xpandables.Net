...
/// <summary>
/// Defines a factory for creating instances of the inbox event data context.
/// </summary>
/// <remarks>Implementations of this interface are responsible for providing new instances of the data context
/// used to interact with the inbox store. This is typically used to ensure that each operation has its own context
/// instance, supporting scenarios such as dependency injection and unit of work patterns.</remarks>
public interface IInboxStoreDataContextFactory
{
    /// <summary>
