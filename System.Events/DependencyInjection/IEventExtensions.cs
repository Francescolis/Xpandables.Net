...
public static class IEventExtensions
{
	...
	public static IServiceCollection AddXEventContextAccessor(this IServiceCollection services)
	{
	...
	public static IServiceCollection AddXDomainEventEnricher<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TDomainEventEnricher>(this IServiceCollection services)
	...
	public static IServiceCollection AddXIntegrationEventEnricher<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TIntegrationEventEnricher>(this IServiceCollection services)
	...
	public static IServiceCollection AddXEventHandlerInboxDecorator(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXIntegrationEventEnricher(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXDomainEventEnricher(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXAggregateStore<TAggregate>(this IServiceCollection services)
	...
	/// <param name="services">The IServiceCollection instance to which the aggregate store will be added.</param>
	...
	public static IServiceCollection AddXAggregateStore(this IServiceCollection services, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type aggregateStoreType)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXAggregateStore(this IServiceCollection services) =>
	...
	public static IServiceCollection AddXEventSubscriber<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TEventSubscriber>(this IServiceCollection services,
	...
	public static IServiceCollection AddXEventSubscriber(this IServiceCollection services, ServiceLifetime lifetime = ServiceLifetime.Singleton) =>
	...
	public static IServiceCollection AddXScheduler<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TScheduler>(this IServiceCollection services)
	...
	public static IServiceCollection AddXScheduler(this IServiceCollection services) =>
	...
	public static IServiceCollection AddXHostedScheduler<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THostedScheduler>(this IServiceCollection services)
	...
	public static IServiceCollection AddXHostedScheduler(this IServiceCollection services) =>
	...
	public static IServiceCollection AddXEventBus<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TEventBus>(this IServiceCollection services)
	...
	/// </remarks>
	public static IServiceCollection AddXCompositeEventPublisher(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXEventPublisher<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TEventPublisher>(this IServiceCollection services,
			ServiceLifetime lifetime = ServiceLifetime.Singleton)
	...
	/// </remarks>
	public static IServiceCollection AddXEventHandler<TEvent, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TEventHandler>(this IServiceCollection services, Func<IServiceProvider, TEventHandler>? factory)
	...
	public static IServiceCollection AddXEventHandlerWrapper<TEvent>(this IServiceCollection services)
		where TEvent : class, IEvent
	{
	...
	/// <summary>
	/// Adds the specified domain store implementation to the service collection with a scoped lifetime.
	/// </summary>
	/// <remarks>This method registers the specified domain store type as the implementation for
	/// IDomainStore. If an IDomainStore service is already registered, this method does not overwrite the existing
	/// registration.</remarks>
	/// <typeparam name="TDomainStore">The type of the domain store to register. Must implement the IDomainStore interface and have a public
	/// constructor.</typeparam>
	/// <returns>The IServiceCollection instance for chaining additional service configuration.</returns>
	public static IServiceCollection AddXDomainStore<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TDomainStore>(this IServiceCollection services)
		where TDomainStore : class, IDomainStore
	{
		ArgumentNullException.ThrowIfNull(services);
		services.TryAddScoped<IDomainStore, TDomainStore>();
		return services;
	}
	...
	/// <returns>The same <see cref="IServiceCollection"/> instance, enabling method chaining.</returns>
	public static IServiceCollection AddXInboxStore<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TInboxStore>(this IServiceCollection services)
