...
/// <summary>
/// Provides a default implementation of <see cref="IEventEnricher"/> that enriches domain events with correlation and
...
public sealed class DefaultDomainEventEnricher(IEventContextAccessor accessor) : IEventEnricher
{
