...
/// <summary>
/// Defines the contract for a domain store that supports appending, reading, deleting, truncating, and subscribing to
/// domain streams in an asynchronous and scalable manner.
/// </summary>
/// <remarks>The domain store interface provides core operations for working with domain streams, including
...
public interface IDomainStore : ISnapshotStore
{
	/// <summary>
