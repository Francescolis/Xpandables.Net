...
/// into child async contexts. It enables singleton services (such as <see cref="EventHandlerWrapper{TEvent}"/>)
/// to resolve scoped event handlers from the correct request scope instead of creating an isolated child scope
/// that would receive separate scoped service instances.</para>
