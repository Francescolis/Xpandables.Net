...
/// </remarks>
public interface IRequiresCacheable : IRequest
{
	/// <summary>
...
/// implementing <see cref="IRequiresCacheable"/>.
/// </summary>
/// <typeparam name="TRequest">The type of the request. Must implement <see cref="IRequiresCacheable"/>.</typeparam>
...
public sealed class PipelineCachingDecorator<TRequest>(IMemoryCache cache) :
	...
	where TRequest : class, IRequiresCacheable
{
	/// <inheritdoc/>
