...
public static class PrimitivesExtensions
{
	...
	public static IServiceCollection AddXHttpStatusCodeExtension<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] THttpStatusCodeExtension>(this IServiceCollection services)
	...
	public static IServiceCollection AddXHttpStatusCodeExtension(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXCacheTypeResolver<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TCacheTypeResolver>(this IServiceCollection services)
	...
	public static IServiceCollection AddXCacheTypeResolver(this IServiceCollection services, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type cacheTypeResolver)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXCacheTypeResolver(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	public static IServiceCollection AddXCacheTypeResolver(this IServiceCollection services, params IEnumerable<Assembly> assemblies)
	{
		ArgumentNullException.ThrowIfNull(services);
	...
	[RequiresUnreferencedCode("Uses reflection to load types from assemblies.")]
	public static IServiceCollection AddXCacheTypeResolver(this IServiceCollection services, Predicate<Type> predicate, params IEnumerable<Assembly> assemblies)
	{
		ArgumentNullException.ThrowIfNull(services);
