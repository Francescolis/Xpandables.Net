...
public static class ExceptionExtensions
{
	...
	/// </summary>
	/// <param name="exception">The exception from which to extract the message chain.</param>
	...
	/// </summary>
	/// <param name="exception">The exception from which to extract element entries.</param>
	...
	public static ElementCollection GetElementEntries(this Exception exception)
	{
		ArgumentNullException.ThrowIfNull(exception);
