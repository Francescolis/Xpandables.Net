...
public static class HttpStatusCodeExtensions
{
	...
	extension(HttpStatusCode statusCode)
	{
		...
		public bool IsRedirect => (int)statusCode is >= 300 and <= 399;
		...
		public bool IsClientError => (int)statusCode is >= 400 and <= 499;
		/// <summary>
		...
		public bool IsServerError => (int)statusCode is >= 500 and <= 599;
		...
		public bool IsInformational => (int)statusCode is >= 100 and <= 199;
		...
		/// <param name="innerException">An optional inner exception to include as the cause of the returned exception.</param>
		...
		public Exception GetException(string message, Exception? innerException = null)
		{
			...
			{
				// 4xx Client Errors
				HttpStatusCode.BadRequest => new ArgumentException(message, innerException),
				HttpStatusCode.Unauthorized => new UnauthorizedAccessException(message, innerException),
				HttpStatusCode.PaymentRequired => new InvalidOperationException(message, innerException),
				HttpStatusCode.Forbidden => new SecurityException(message, innerException),
				HttpStatusCode.NotFound => new KeyNotFoundException(message, innerException),
				HttpStatusCode.MethodNotAllowed => new NotSupportedException(message, innerException),
				HttpStatusCode.NotAcceptable => new InvalidOperationException(message, innerException),
				HttpStatusCode.ProxyAuthenticationRequired => new AuthenticationException(message, innerException),
				HttpStatusCode.RequestTimeout => new TimeoutException(message, innerException),
				HttpStatusCode.Conflict => new IOException(message, innerException),
				HttpStatusCode.Gone => new InvalidOperationException(message, innerException),
				HttpStatusCode.LengthRequired => new ArgumentException(message, innerException),
				HttpStatusCode.PreconditionFailed => new VersionNotFoundException(message, innerException),
				HttpStatusCode.RequestEntityTooLarge => new InvalidDataException(message, innerException),
				HttpStatusCode.RequestUriTooLong => new UriFormatException(message, innerException),
				HttpStatusCode.UnsupportedMediaType => new InvalidOperationException(message, innerException),
				HttpStatusCode.RequestedRangeNotSatisfiable => new ArgumentOutOfRangeException(message: message, innerException: innerException),
				HttpStatusCode.ExpectationFailed => new InvalidOperationException(message, innerException),
				(HttpStatusCode)422 => new DataException(message, innerException), // Unprocessable Entity
				(HttpStatusCode)423 => new SynchronizationLockException(message, innerException), // Locked
				(HttpStatusCode)424 => new InvalidOperationException(message, innerException), // Failed Dependency
				(HttpStatusCode)428 => new InvalidOperationException(message, innerException), // Precondition Required
				(HttpStatusCode)429 => new InvalidOperationException(message, innerException), // Too Many Requests
				(HttpStatusCode)431 => new InvalidOperationException(message, innerException), // Request Header Fields Too Large
				(HttpStatusCode)451 => new InvalidOperationException(message, innerException), // Unavailable For Legal Reasons

				// 5xx Server Errors
				HttpStatusCode.InternalServerError => new InvalidOperationException(message, innerException),
				HttpStatusCode.NotImplemented => new NotImplementedException(message, innerException),
				HttpStatusCode.BadGateway => new WebException(message, innerException),
				HttpStatusCode.ServiceUnavailable => new InvalidOperationException(message, innerException),
				HttpStatusCode.GatewayTimeout => new TimeoutException(message, innerException),
				HttpStatusCode.HttpVersionNotSupported => new InvalidOperationException(message, innerException),
				(HttpStatusCode)506 => new InvalidOperationException(message, innerException), // Variant Also Negotiates
				(HttpStatusCode)507 => new InsufficientMemoryException(message, innerException), // Insufficient Storage
				(HttpStatusCode)508 => new InvalidOperationException(message, innerException), // Loop Detected
				(HttpStatusCode)510 => new InvalidOperationException(message, innerException), // Not Extended
				(HttpStatusCode)511 => new AuthenticationException(message, innerException), // Network Authentication Required

				// 1xx, 2xx, 3xx and default cases
				_ => new InvalidOperationException(message, innerException)
			};
		}
	}
}
