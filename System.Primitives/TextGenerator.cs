...
/// <summary>
/// Provides methods for generating random strings using specified characters.
/// </summary>
/// <remarks>This class includes methods to generate random strings of a specified length, utilizing either
/// default or custom lookup characters. The generated strings can include a variety of characters, making them suitable
/// for use in scenarios such as password generation or unique identifiers.</remarks>
public static class TextGenerator
{
	...
	public const string LookupCharacters = "abcdefghijklmonpqrstuvwxyzABCDEFGH" +
		"IJKLMNOPQRSTUVWXYZ0123456789,;!(-Ë_Á‡‡)=@%µ£®//?ß/.?";
	...
	public static string Generate(int length) => Generate(length, LookupCharacters);
