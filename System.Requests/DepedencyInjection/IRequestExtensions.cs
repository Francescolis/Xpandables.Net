...
public static class IRequestExtensions
{
	...
	[
		...
		typeof(IRequestStreamHandler<,>),
		typeof(IRequestContextStreamHandler<,>),
	...
	/// such as <see cref="IRequestHandler{TRequest}"/>, <see cref="IRequestContextHandler{TRequest}"/>,
	/// <see cref="IRequestContextHandler{TRequest, TResponse}"/>, <see cref="IRequestExceptionHandler{TRequest}"/>,
	/// <see cref="IRequestPostHandler{TRequest}"/>, <see cref="IRequestPreHandler{TRequest}"/> and related
