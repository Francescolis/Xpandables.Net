...
public static class IRestsExtensions
{
	...
	public static IHttpClientBuilder AddXRestClient<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TRestClient>(this IServiceCollection services,
	...
	public static IHttpClientBuilder AddXRestClient(this IServiceCollection services,
		Action<IServiceProvider, HttpClient> configureClient) =>
		services
	...
	/// <returns>An <see cref="IHttpClientBuilder"/> that can be used to further configure the HTTP client.</returns>
	public static IHttpClientBuilder AddXRestClientWithResilience(this IServiceCollection services,
		Action<IServiceProvider, HttpClient> configureClient)
	{
	...
	/// </summary>
	/// <param name="services">The IServiceCollection instance to which the REST request composers will be added.</param>
