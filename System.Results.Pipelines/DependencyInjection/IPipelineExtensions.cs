...
public static class IPipelineExtensions
{
	...
	public static IServiceCollection AddXPipelineRequireEntityUnitOfWorkDecorator(this IServiceCollection services) =>
	...
	public static IServiceCollection AddXPipelineCommitDomainEventDecorator(this IServiceCollection services)
	{
	...
	public static IServiceCollection AddXPipelinePublishDomainEventDecorator(this IServiceCollection services)
	{
		ArgumentNullException.ThrowIfNull(services);
		return services
	...
	public static IServiceCollection ValidateXPipelineRegistration(this IServiceCollection services, Action<string>? onWarning = null)
	{
		ArgumentNullException.ThrowIfNull(services);
