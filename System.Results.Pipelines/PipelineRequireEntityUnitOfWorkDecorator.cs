...
public sealed class PipelineRequireEntityUnitOfWorkDecorator<TRequest>(IEntityUnitOfWork? unitOfWork = default) :
	...
	where TRequest : class, IRequest, IEntityRequiresUnitOfWork
{
		...
		CancellationToken cancellationToken = default)
	{
		...
		IEntityUnitOfWorkTransaction transaction = await unitOfWork
