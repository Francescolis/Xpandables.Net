...
{
	/// <summary>
	/// Gets the Failure Result associated with this exception.
	/// </summary>
	public FailureResult Result { get; }
	...
	public ResultException(FailureResult result)
	...
	public ResultException(string message, FailureResult result)
		: base(message)
	{
	...
	public ResultException(
		string message, FailureResult result, Exception innerException)
		...
		: base(serializationInfo, streamingContext)
	{
		...
		Result = (FailureResult)serializationInfo
			.GetValue(nameof(Result), typeof(FailureResult))!;
	}
	...
	public override void GetObjectData(SerializationInfo info, StreamingContext context)
	{
		...
		info.AddValue(nameof(Result), Result, typeof(FailureResult));
	}
