...
/// <summary>
/// Provides extension methods for executing operations and capturing their results, converting exceptions to Result
...
public static class ResultExtensions
{
	...
	public static Result<TResult> Try<TResult>(this Func<TResult> func)
	{
		...
		try
		{
			return ResultWith.Success(func());
		}
		...
		{
			return exception.ToResult().ToResult<TResult>();
		}
	}
		...
		this Task<TValue> task)
	{
		...
		catch (ResultException executionException)
		{
			...
			when (exception is not ResultException)
		{
			return exception.ToResult().ToResult<TValue>();
		}
	}
}
