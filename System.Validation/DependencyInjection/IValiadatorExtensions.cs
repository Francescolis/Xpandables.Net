...
public static class IValiadatorExtensions
{
	...
	public static IServiceCollection AddXCompositeValidator(this IServiceCollection services)
	{
	...
	public static IServiceCollection AddXValidatorFactory<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValidatorFactory>(
	...
	public static IServiceCollection AddXValidatorFactory(this IServiceCollection services, IValidatorFactory factory)
	{
	...
	public static IServiceCollection AddXValidatorFactory(this IServiceCollection services) =>
	...
	/// <param name="services">The <see cref="IServiceCollection"/> to add the services to.</param>
	/// <returns>The IServiceCollection instance for chaining additional service registrations.</returns>
	public static IServiceCollection AddXValidatorProvider<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValidatorProvider>(
		this IServiceCollection services)
	...
	/// <returns>The <see cref="IServiceCollection"/> instance, to allow for method chaining.</returns>
	public static IServiceCollection AddXValidatorProvider(this IServiceCollection services, IValidatorProvider provider)
	{
	...
	/// Validator-based validation in the application's dependency injection container.</returns>
	public static IServiceCollection AddXValidatorProvider(this IServiceCollection services) =>
	...
	public static IServiceCollection AddXValidators(this IServiceCollection services, params IEnumerable<Assembly> assemblies)
	{
