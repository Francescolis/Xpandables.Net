...
public sealed record PersonCreateRequested : EventDomain<Person>, IEventDuplicateDecorator
{
    ...
    {
        EventTypeName = nameof(PersonCreateRequested),
        KeyId = AggregateId,
    ...
    public IOperationResult OnFailure() => OperationResults
            .Conflict()
            .WithError(nameof(FirstName), "Person already exists")
            .WithError(nameof(LastName), "Person already exists")
            .Build();
}
