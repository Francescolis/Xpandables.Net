...
public static class RouteHandlerBuilderExtensions
{
    ...
    /// <see cref="Http.MapRest.ContentType.Json"/>.</remarks>
    public static RouteHandlerBuilder Accepts<TRequest>(
        this RouteHandlerBuilder builder)
        where TRequest : notnull =>
        builder.Accepts<TRequest>(Http.MapRest.ContentType.Json);
    ...
    public static TBuilder Produces400BadRequest<TBuilder>(
        ...
        builder.ProducesValidationProblem(
            ...
            Http.MapRest.ContentType.JsonProblem);
