...
namespace Xpandables.Net.Http.Controllers;
            ...
            try
            {
                ...
                if (jsonTypeInfo is not null)
                {
                    await JsonSerializer
                        .SerializeAsyncPaged(pipeWriter, paged, jsonTypeInfo, httpContext.RequestAborted)
                        .ConfigureAwait(false);
                }
                else
                {
                    await JsonSerializer.SerializeAsyncPaged(
                        pipeWriter, paged, SerializerOptions, httpContext.RequestAborted)
                        .ConfigureAwait(false);
                }
            }
