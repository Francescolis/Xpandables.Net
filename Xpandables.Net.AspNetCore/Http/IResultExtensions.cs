...
public static class IResultExtensions
{
    ...
    extension<TResult>(IAsyncPagedEnumerable<TResult> source)
    {
        ...
        public IResult ToResult(JsonTypeInfo<TResult> jsonTypeInfo) => new MinimalResultAsyncPaged<TResult>(source, default, jsonTypeInfo);
        ...
        /// <returns>An <see cref="IResult"/> that represents the asynchronous paged enumerable.</returns>
        public IResult ToResult(JsonSerializerOptions serializerOptions) => new MinimalResultAsyncPaged<TResult>(source, serializerOptions);
        ...
        public IResult ToResult() => new MinimalResultAsyncPaged<TResult>(source);
    }
}
