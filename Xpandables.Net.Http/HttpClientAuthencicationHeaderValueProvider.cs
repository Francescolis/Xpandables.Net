...
/// or returns the value to be used for the <see cref="AuthenticationHeaderValue"/> if not null.
/// </summary>
...
public delegate string? HttpClientAuthenticationHeaderValueProvider(HttpRequestMessage request);