...
/// <summary>
/// Represents a request to truncate an event stream up to a specified version.
/// </summary>
public readonly record struct TruncateStreamRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="TruncateStreamRequest"/> class.
    /// </summary>
    public TruncateStreamRequest()
    {
    }
    /// <summary>
    /// Gets the identifier of the event stream to truncate.
    /// </summary>
