    ...
    where TResult : notnull
{
        ...
        RestResponseStreamContext<TResult> context, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var asyncPagedResult = typeInfo is null
                ? response.Content.ReadFromJsonAsAsyncEnumerable<TResult>(options, cancellationToken)
                : response.Content.ReadFromJsonAsAsyncEnumerable(typeInfo, cancellationToken);
