...
internal sealed class EventIntegrationSchedulerInternal(
    IServiceScopeFactory scopeFactory,
    IOptions<SchedulerOptions> options,
    ILogger<EventIntegrationSchedulerInternal> logger)
    : BackgroundServiceBase<EventIntegrationSchedulerInternal>,
    IEventIntegrationScheduler
{
                                    ...
                                    .ConfigureAwait(false))
        {
            ...
            catch (OperationCanceledException cancelException)
            {
                logger.CancelExecutingProcess(
                    nameof(EventIntegrationSchedulerInternal),
                    cancelException);
