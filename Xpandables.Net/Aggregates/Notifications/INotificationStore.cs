...
public interface INotificationStore : IDisposable
{
    ...
    /// <summary>
    /// Asynchronously sets the exception that occurred while processing the specified notification,
    ...
    /// </summary>
    /// <param name="filter">The filter to search notification for.</param>
    /// <param name="cancellationToken">A CancellationToken to observe while waiting for the task to complete.</param>
    /// <returns>An enumerator of <see cref="INotification"/> type that can be asynchronously enumerated.</returns>
    /// <exception cref="ArgumentNullException">The <paramref name="filter"/> is null.</exception>
    /// <exception cref="InvalidOperationException">The operation failed. See inner exception.</exception>
    IAsyncEnumerable<INotification> ReadAsync(
