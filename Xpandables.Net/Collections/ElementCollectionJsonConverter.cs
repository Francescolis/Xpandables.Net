...
public sealed class ElementCollectionJsonConverter : JsonConverter<ElementCollection>
{
    ...
    {
        ElementEntry[]? entries = JsonSerializer.Deserialize(ref reader, Text.CoreJsonSerializerContext.Default.ElementEntryArray);
    ...
    public override void Write(
        ...
        JsonSerializerOptions options) =>
        JsonSerializer.Serialize(writer, value.ToArray(), Text.CoreJsonSerializerContext.Default.ElementEntryArray);
}