...
public static partial class ServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Registers the <typeparamref name="THttpClientRequestBuilder"/> type implementation to the services with scope life time.
    /// </summary>
    ...
    /// <summary>
    /// Registers the <see cref="IHttpClientResponseBuilder"/> default implementation to the services with scope life time.
    /// </summary>
    /// <param name="services">The collection of services.</param>
    /// <exception cref="ArgumentNullException">The <paramref name="services"/> is null.</exception>
    /// <returns>The <see cref="IServiceCollection"/> services.</returns>
    ...
    /// <summary>
    /// Registers the <typeparamref name="THttpClientResponseBuilder"/> type implementation to the services with scope life time.
    /// </summary>
    ...
    public static IHttpClientBuilder AddXHttpClientDispatcher(
        this IServiceCollection services,
        AuthenticationHeaderValueProvider authenticationHeaderValue,
        Action<IServiceProvider, HttpClient> configureClient)
    {
        ArgumentNullException.ThrowIfNull(services);
    ...
    /// <summary>
    /// Registers the <typeparamref name="THttpClientDispatcherImpl"/> type as <typeparamref name="THttpClientDispatcherInterface"/>
    /// to be used as <see cref="IHttpClientDispatcher"/>.
    /// </summary>
    /// <typeparam name="THttpClientDispatcherInterface">The interface type that inherits from <see cref="IHttpClientDispatcher"/>.</typeparam>
    /// <typeparam name="THttpClientDispatcherImpl">The type that implements <typeparamref name="THttpClientDispatcherInterface"/>.</typeparam>
    /// <param name="services">The collection of services.</param>
    /// <returns>The <see cref="IHttpClientBuilder"/> instance.</returns>
    /// <exception cref="ArgumentNullException">The <paramref name="services"/> is null.</exception>
