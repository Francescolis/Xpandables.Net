...
{
    internal readonly static MethodInfo AddRepositoryMethod = typeof(ServiceCollectionExtensions).GetMethod(nameof(AddXRepository))!;
    internal readonly static MethodInfo AddRepositoryForMethod = typeof(ServiceCollectionExtensions).GetMethod(nameof(AddXRepositoryFor))!;

    /// <summary>
    /// Registers the <typeparamref name="TRepository"/> to the services with scope life time using the factory if specified.
    /// </summary>
