...
{
    internal readonly static MethodInfo AddVisitorMethod = typeof(ServiceCollectionExtensions).GetMethod(nameof(AddXVisitor))!;
    ...
    /// <summary>
    /// Adds visitor behavior to commands and queries that are decorated with the <see cref="IVisitable"/> interface to the services
