...
/// </summary>
/// <remarks>The <see cref="EventEnvelope"/> is used to encapsulate an event along with its associated metadata, 
/// such as the event's unique identifier, type, timestamp, and its position in the global event stream.  It also
/// includes optional information about the aggregate to which the event belongs, if applicable.</remarks>
public readonly record struct EventEnvelope
{
    ...
    /// <summary>
    /// Gets the unique identifier of the aggregate associated with this instance.
    /// </summary>
    public readonly Guid? AggregateId { get; init; }
    /// <summary>
    /// Gets the name of the aggregate, or <see langword="null"/> if no name is specified.
    /// </summary>
    public readonly string? AggregateName { get; init; }
    /// <summary>
