...
internal sealed class EventSchedulerInternal(
    IServiceScopeFactory scopeFactory,
    IOptions<SchedulerOptions> options,
    IOptions<EventOptions> eventOptions,
    ILogger<EventSchedulerInternal> logger)
    : BackgroundServiceBase<EventSchedulerInternal>,
    IEventScheduler
{
