...
/// <see cref="HttpRequestAuthorizationHandler"/> class.
...
/// </remarks>
public abstract class HttpRequestAuthorizationHandler : HttpClientHandler
{
    /// <summary>
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!request.Options
            .TryGetValue(
                new(nameof(MapHttpAttribute.IsSecured)),
