...
/// <summary>
/// Represents a validation dictionary for HTTP client operations.
/// </summary>
public sealed class HttpRequestValidation : Dictionary<string, IEnumerable<string>>
{
    /// <summary>
    ...
    /// copied to the new <see cref="HttpRequestValidation"/>.</param>
    /// <exception cref="ArgumentNullException">The 
