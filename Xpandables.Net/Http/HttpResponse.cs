...
/// </summary>
public class HttpResponse : Disposable, IEquatable<HttpResponse>
{
    /// <summary>
    ...
    /// <summary>  
    /// Initializes a new instance of the <see cref="HttpResponse"/> 
    ...
    /// </summary>
    /// <returns>The current instance of <see cref="HttpResponse"/>.</returns>
...
public class ResponseHttp<TResult> : HttpResponse, IEquatable<ResponseHttp<TResult>>
{
    /// <summary>  
