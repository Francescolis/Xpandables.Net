...
{
    /// <summary>
    /// Builds the <see cref="HttpClientRequestOptionsAttribute"/> using the 
    /// provided <see cref="IServiceProvider"/>.
    /// </summary>
    /// <param name="serviceProvider">The service provider to use for 
    /// building the options.</param>
    /// <returns>The built <see cref="HttpClientRequestOptionsAttribute"/>.</returns>
    HttpClientRequestOptionsAttribute Build(IServiceProvider serviceProvider);
}
