...
/// <summary>
/// Specifies the content of an <see cref="IRestRequest"/>.
/// </summary>
public interface IRestContent
{
    /// <summary>
    /// Returns the name of the type of the current instance. It provides the class name as a string.
    /// </summary>
...
/// </summary>
public interface IRestContentBasicAuthentication : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentByteArray : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentCookie : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentFormUrlEncoded : IRestContent
{
    /// <summary>
...
public interface IRestContentHeader : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentMultipart : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentPathString : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentQueryString : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentStream : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentString : IRestContent
{
    /// <summary>
...
/// </summary>
public interface IRestContentPatch : IRestContent
{
    /// <summary>
...
/// <summary>
/// Helper used to implement the <see cref="IRestContentPatch"/> interface.
/// </summary>
/// <typeparam name="TRecord">The target patch record type.</typeparam>
public abstract record RestContentPatch<TRecord> : IRestContentPatch
