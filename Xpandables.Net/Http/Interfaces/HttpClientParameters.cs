...
public static class HttpClientParameters
{
    ...
    public enum Location
    {
        ...
        /// You can use <see cref="IStringRequest"/>,
        /// <see cref="IPatchRequest"/>, <see cref="IStreamRequest"/>, 
        /// <see cref="IByteArrayRequest"/>, 
        /// <see cref="IMultipartRequest"/> or
        ...
        /// <see cref="IQueryStringRequest"/> to provide with content.
        /// </summary>
        Query = 2,
        ...
        /// You must implement <see cref="IPathStringRequest"/> 
        ...
        /// You must implement <see cref="IHeaderRequest"/> 
        /// to provide with content.
        /// </summary>
        Header = 8,
        ...
        /// You must <see cref="ICookieRequest"/> to provide with content.
        /// </summary>
        Cookie = 16,

        /// <summary>
        /// Used to pass basic auth information to the API.
        /// You must implement <see cref="IBasicAuthRequest"/>
        /// </summary> 
        BasicAuth = 32
    }
    ...
    public enum BodyFormat
    {
        ...
        /// The target class should implement <see cref="IStringRequest"/> or
        /// <see cref="IPatchRequest"/>, otherwise the 
        /// whole class will be serialized.
        /// </summary>
