...
/// </summary>
public interface IPatchRequest : IDefinitionRequest
{
    /// <summary>
...
/// <summary>
/// Helper used to implement the <see cref="IPatchRequest"/> interface.
/// </summary>
/// <typeparam name="TRecord">The target patch record type.</typeparam>
public abstract record HttpRequestPatch<TRecord> : IPatchRequest
