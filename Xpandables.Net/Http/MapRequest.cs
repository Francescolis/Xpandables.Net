...
/// <summary>
/// Provides with <see cref="MapHttpAttribute"/> behaviors.
/// </summary>
public static class MapRequest
{
    ...
    public enum Location
    {
        ...
        /// You can use <see cref="IHttpRequestContentString"/>,
        /// <see cref="IHttpRequestContentPatch"/>, <see cref="IHttpRequestContentStream"/>, 
        /// <see cref="IHttpRequestContentByteArray"/>, 
        /// <see cref="IHttpRequestContentMultipart"/> or
        ...
        /// <see cref="IHttpRequestContentQueryString"/> to provide with content.
        /// </summary>
        Query = 2,
        ...
        /// You must implement <see cref="IHttpRequestContentPathString"/> 
        ...
        /// You must implement <see cref="IHttpRequestContentHeader"/> 
        /// to provide with content.
        /// </summary>
        Header = 8,
        ...
        /// You must <see cref="IHttpRequestContentCookie"/> to provide with content.
        /// </summary>
        Cookie = 16,

        /// <summary>
        /// Used to pass basic auth information to the API.
        /// You must implement <see cref="IHttpRequestContentBasicAuthentication"/>
        /// </summary> 
        BasicAuth = 32
    }
    ...
    public enum BodyFormat
    {
        ...
        /// The target class should implement <see cref="IHttpRequestContentString"/> or
        /// <see cref="IHttpRequestContentPatch"/>, otherwise the 
        /// whole class will be serialized.
        /// </summary>
...
#pragma warning restore CA1720 // Identifier contains type name
        ...
        /// The target class should implement <see cref="IHttpRequestContentByteArray"/>.
        /// </summary>
        ByteArray,

        /// <summary>
        /// Body content matching the <see cref="MultipartFormDataContent"/>.
        /// The target class should implement <see cref="IHttpRequestContentMultipart"/>.
        /// </summary>
        Multipart,

        /// <summary>
        /// Body content matching the <see cref="StreamContent"/>.
        /// The target class should implement <see cref="IHttpRequestContentStream"/>.
        /// </summary>
        Stream,
