...
/// </summary>  
public sealed class HttpClientBasicAuthRequestBuilder :
   HttpClientRequestBuilder<IBasicAuthRequest>
{
    /// <inheritdoc/>  
    ...
    public override void Build(HttpClientRequestContext context)
    {
        ...
        IBasicAuthRequest request = (IBasicAuthRequest)context.Request;
