...
/// </summary>
public sealed class HttpClientByteArrayRequestBuilder :
    HttpClientRequestBuilder<IByteArrayRequest>
{
    /// <inheritdoc/>
    ...
    public override void Build(HttpClientRequestContext context)
    {
        ...
        {
            IByteArrayRequest request = (IByteArrayRequest)context.Request;
