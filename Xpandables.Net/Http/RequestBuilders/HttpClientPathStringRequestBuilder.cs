...
/// </summary>
public sealed class HttpClientPathStringRequestBuilder :
    HttpClientRequestBuilder<IPathStringRequest>
{
    /// <inheritdoc/>
    ...
    public override void Build(HttpClientRequestContext context)
    {
        ...
        IPathStringRequest request = (IPathStringRequest)context.Request;
