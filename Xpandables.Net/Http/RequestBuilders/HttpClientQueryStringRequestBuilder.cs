...
/// </summary>
public sealed class HttpClientQueryStringRequestBuilder :
    HttpClientRequestBuilder<IQueryStringRequest>
{
    /// <inheritdoc/>
    ...
    public override void Build(HttpClientRequestContext context)
    {
        ...
        IQueryStringRequest request = (IQueryStringRequest)context.Request;
