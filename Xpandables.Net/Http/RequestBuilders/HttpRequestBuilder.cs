...
/// </summary>
/// <typeparam name="THttpRequestContent">The type of the request content.</typeparam>
public abstract class HttpRequestBuilder<THttpRequestContent> : IHttpRequestBuilder<THttpRequestContent>
    where THttpRequestContent : class, IHttpRequestContent
{
    ///<inheritdoc/>
    public Type Type => typeof(THttpRequestContent);
