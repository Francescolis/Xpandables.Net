...
/// </summary>
public sealed class HttpRequestByteArrayBuilder : HttpRequestBuilder<IHttpRequestContentByteArray>
{
    /// <inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        {
            IHttpRequestContentByteArray request = (IHttpRequestContentByteArray)context.Request;
