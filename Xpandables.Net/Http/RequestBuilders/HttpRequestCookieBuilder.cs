...
/// <summary>
/// A builder class for constructing HTTP client requests with cookies.
/// </summary>
public sealed class HttpRequestCookieBuilder : HttpRequestBuilder<IHttpRequestContentCookie>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        IHttpRequestContentCookie request = (IHttpRequestContentCookie)context.Request;
