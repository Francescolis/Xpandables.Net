...
/// </summary>
public sealed class HttpRequestHeaderBuilder : HttpRequestBuilder<IHttpRequestContentHeader>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        IHttpRequestContentHeader request = (IHttpRequestContentHeader)context.Request;
