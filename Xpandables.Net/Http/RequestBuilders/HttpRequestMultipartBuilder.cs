...
/// <summary>
/// A builder class for creating HTTP client requests with multipart content.
/// </summary>
public sealed class HttpRequestMultipartBuilder : HttpRequestBuilder<IHttpRequestContentMultipart>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        {
            IHttpRequestContentMultipart request = (IHttpRequestContentMultipart)context.Request;
