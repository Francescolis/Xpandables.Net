...
/// </summary>
public sealed class HttpRequestPatchBuilder : HttpRequestBuilder<IHttpRequestContentPatch>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        IHttpRequestContentPatch request = (IHttpRequestContentPatch)context.Request;
