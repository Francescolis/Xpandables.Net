...
/// <summary>
/// Builds HTTP client requests with string content.
/// </summary>
public sealed class HttpRequestStringBuilder : HttpRequestBuilder<IHttpRequestContentString>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        IHttpRequestContentString request = (IHttpRequestContentString)context.Request;
