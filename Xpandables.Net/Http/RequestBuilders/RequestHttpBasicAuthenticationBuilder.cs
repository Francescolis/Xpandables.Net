...
/// </summary>  
public sealed class RequestHttpBasicAuthenticationBuilder : RequestHttpBuilder<IRequestBasicAuthentication>
{
    /// <inheritdoc/>         
    public override void Build(RequestContext context)
    {
        ...
        IRequestBasicAuthentication request = (IRequestBasicAuthentication)context.Request;
