...
/// </summary>
public sealed class RequestHttpQueryStringBuilder : RequestHttpBuilder<IRequestQueryString>
{
    ///<inheritdoc/>
    public override void Build(RequestContext context)
    {
        ...
        IRequestQueryString request = (IRequestQueryString)context.Request;
