...
/// </summary>
/// <remarks>
/// Your class can implement the <see cref="IRequestDefinitionBuilder"/>
/// to dynamically return a <see cref="RequestDefinitionAttribute"/>.</remarks>
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct,
    Inherited = false, AllowMultiple = false)]
public sealed class RequestDefinitionAttribute : Attribute
{
    /// <summary>
    /// Initializes the default instance of <see cref="RequestDefinitionAttribute"/>.
    /// </summary>
    public RequestDefinitionAttribute() { }
