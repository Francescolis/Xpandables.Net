...
public static class RequestDefinitions
{
    ...
    public enum Location
    {
        ...
        /// You can use <see cref="IRequestString"/>,
        /// <see cref="IRequestPatch"/>, <see cref="IRequestStream"/>, 
        /// <see cref="IRequestByteArray"/>, 
        /// <see cref="IRequestMultipart"/> or
        ...
        /// <see cref="IRequestQueryString"/> to provide with content.
        /// </summary>
        Query = 2,
        ...
        /// You must implement <see cref="IRequestPathString"/> 
        ...
        /// You must implement <see cref="IRequestHeader"/> 
        /// to provide with content.
        /// </summary>
        Header = 8,
        ...
        /// You must <see cref="IRequestCookie"/> to provide with content.
        /// </summary>
        Cookie = 16,

        /// <summary>
        /// Used to pass basic auth information to the API.
        /// You must implement <see cref="IRequestBasicAuthentication"/>
        /// </summary> 
        BasicAuth = 32
    }
    ...
    public enum BodyFormat
    {
        ...
        /// The target class should implement <see cref="IRequestString"/> or
        /// <see cref="IRequestPatch"/>, otherwise the 
        /// whole class will be serialized.
        /// </summary>
...
#pragma warning restore CA1720 // Identifier contains type name
        ...
        /// The target class should implement <see cref="IRequestByteArray"/>.
        /// </summary>
        ByteArray,

        /// <summary>
        /// Body content matching the <see cref="MultipartFormDataContent"/>.
        /// The target class should implement <see cref="IRequestMultipart"/>.
        /// </summary>
        Multipart,

        /// <summary>
        /// Body content matching the <see cref="StreamContent"/>.
        /// The target class should implement <see cref="IRequestStream"/>.
        /// </summary>
        Stream,
