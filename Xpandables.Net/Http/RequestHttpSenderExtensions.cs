...
/// <summary>
/// Provides extension methods for <see cref="IRequestHttpSender"/>.
/// </summary>
public static class RequestHttpSenderExtensions
{
    /// <summary>
    ...
    /// <summary>
    /// Determines if the given <see cref="RequestException"/> contains 
    /// validation errors.
    /// </summary>
    ...
    public static bool IsHttpClientValidation(
       this RequestException clientException,
       [MaybeNullWhen(false)] out RequestValidation errors,
       ...
       JsonSerializerOptions? options = default)
    {
        ...
        {
            exception = default;
            var anonymousType = new { Errors = default(RequestValidation) };
    ...
    /// <summary>
    /// Converts the <see cref="ResponseHttp"/> to an <see cref="IExecutionResult"/>.
    /// </summary>
        ...
        JsonSerializerOptions? options = default)
    {
        ...
        RequestException responseException = response.Exception;

        if (responseException.IsHttpClientValidation(
            out RequestValidation? errors,
            out _,
            options))
        {
            return ExecutionResults
