...
/// </summary>
public sealed class RequestValidation : Dictionary<string, IEnumerable<string>>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RequestValidation"/> 
    ...
    /// new <see cref="RequestValidation"/>.</param>
    /// <exception cref="ArgumentNullException">The 
    ...
    /// copied to the new <see cref="RequestValidation"/>.</param>
    /// <exception cref="ArgumentNullException">The 
