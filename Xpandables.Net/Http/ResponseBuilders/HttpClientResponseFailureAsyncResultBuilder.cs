...
/// <summary>
/// A builder for creating failure async HTTP client responses of 
/// specific type result.
/// </summary>
public sealed class HttpClientResponseFailureAsyncResultBuilder : IHttpClientResponseBuilder
{
    /// <inheritdoc/>
