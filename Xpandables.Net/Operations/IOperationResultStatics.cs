...
public partial interface IOperationResult
{
    ...
    public static bool IsFailureStatusCode(HttpStatusCode statusCode) => !IsSuccessStatusCode(statusCode);
    ...
    public static HttpStatusCode EnsureSuccessStatusCode(HttpStatusCode statusCode)
    {
    ...
    public static HttpStatusCode EnsureFailureStatusCode(HttpStatusCode statusCode)
    {
