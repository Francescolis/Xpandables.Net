...
/// <summary>
/// A factory for <see cref="OperationResult"/> and <see cref="OperationResult{TResult}"/> using fluent interface.
/// </summary>
public sealed class OperationResults
{
    ...
    public static IOperationResult.ISuccessBuilder Success(HttpStatusCode statusCode = HttpStatusCode.OK)
    ...
    /// <returns>An instance of a type that implements <see cref="IOperationResult.ISuccessBuilder{TResult}"/> 
    /// holding commands that can be chained.</returns>
    public static IOperationResult.ISuccessBuilder<TResult> Ok<TResult>(TResult result)
    {
        SuccessBuilder<TResult> successBuilder = new(HttpStatusCode.OK);
        return ((IOperationResult.ISuccessBuilder<TResult>)successBuilder).WithResult(result);
    }
