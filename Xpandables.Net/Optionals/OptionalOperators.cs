    ...
    IFormattable
{
    ...
    ///<inheritdoc/>
    public readonly T ToT(Optional<T> optional)
        => optional.Value;

    ///<inheritdoc/>
    public static Optional<T> ToOptional([AllowNull] T value)
        => Optional.ToOptional(value);
    ...
    ///<inheritdoc/>
    public readonly bool Equals([AllowNull] T other)
        => HasValue && other is { };
    ...
    ///  to use the default format defined
    ///  for the type of the <see cref="IFormattable" /> implementation.</param>
    /// <param name="formatProvider">The provider to use to format the value.
    ///  -or-
    ///  A null reference (<see langword="Nothing" /> in Visual Basic) 
    ///  to obtain the numeric
    ///  format information from the current locale 
