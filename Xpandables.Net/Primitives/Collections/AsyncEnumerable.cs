...
public static class AsyncEnumerable
{
    ...
    public static IAsyncEnumerable<T> EmptyAsync<T>() => new AsyncEnumerable<T>(Enumerable.Empty<T>());
}
...
public sealed class AsyncEnumerable<T> : IAsyncEnumerable<T>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AsyncEnumerable{T}"/> class with
    /// the collection to be asynchronously enumerated.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AsyncEnumerable{T}"/> class with the delegate enumerator.
    /// </summary>
    ...
    /// </summary>
    /// <param name="cancellationToken">A System.Threading.CancellationToken that may be used
