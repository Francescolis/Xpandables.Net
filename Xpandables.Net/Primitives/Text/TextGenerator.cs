...
public static class TextGenerator
{
    ...
    /// <summary>
    /// Generates a string of the specified length that contains
    /// random characters.
    ...
    /// <returns>A new string of the specified length with random 
    /// characters.</returns>
    /// <exception cref="ArgumentException">The <paramref name="length"/> must 
    ...
    /// <summary>
    /// Generates a string of the specified length that contains random 
    /// characters from the lookup characters.
    /// <para>The implementation uses the 
    /// <see cref="RNGCryptoServiceProvider"/>.</para>
    /// </summary>
    /// <param name="length">The length of the expected string value.</param>
    /// <param name="lookupCharacters">The string to be used to pick 
    /// characters from or default one.</param>
    /// <returns>A new string of the specified length with random 
    /// characters.</returns>
    /// <exception cref="ArgumentException">The <paramref name="length"/> must 
    /// be greater than zero and lower or equal 
    /// to <see cref="ushort.MaxValue"/>.</exception>
    /// <exception cref="ArgumentNullException">The 
    /// <paramref name="lookupCharacters"/> is null.</exception>
