...
/// <summary>
/// Provides a base class for property notification with disposable pattern.
/// </summary>
public abstract class PropertyNotificationDisposable :
    PropertyNotification, IDisposable, IAsyncDisposable
{
    /// <summary>
    /// Initializes a new instance of 
    /// <see cref="PropertyNotificationDisposable"/> class.
    /// </summary>
    protected PropertyNotificationDisposable() : base() { }
...
/// <see cref="PropertyNotificationForAttribute"/> to propagate message
/// .</remarks>
/// <typeparam name="TModel">The type of the target model.</typeparam>
public abstract class PropertyNotificationDisposable<TModel> :
    PropertyNotification<TModel>, IDisposable, IAsyncDisposable
    where TModel : class
{
    /// <summary>
    /// Gets or sets a value indicating whether this instance is disposed.
