...
using Xpandables.Net.Operations.States;

namespace Xpandables.Net.Repositories;

/// <summary>
/// The entity object base implementation that provides an identifier and a key generator for derived class.
...
/// </summary>
/// <typeparam name="TState">The entity state.</typeparam>
    ...
    where TState : class, IState
{
    ...
    protected EntityStateContext(TState state) => TransitionToState(state);
