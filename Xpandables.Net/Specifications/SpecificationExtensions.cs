...
/// <summary>
/// Provides the specification extensions that contains
/// methods to map generic specifications.
/// </summary>
public static class SpecificationExtensions
{
    ...
    public static Specification<TSource> And<TSource>(
        this ISpecification<TSource> left,
        ISpecification<TSource> right)
        => new SpecificationAnd<TSource>(left, right);

    /// <summary>
    /// Applies the AND operator to specification 
    /// and expression, and returns a new specification.
    /// </summary>
    /// <param name="left">The specification left side.</param>
    ...
    public static Specification<TSource> And<TSource>(
        ...
        => new SpecificationAnd<TSource>(
            left,
            new SpecificationExpression<TSource>(right));
    ...
    /// <summary>
    /// Applies the OR operator to specification and expression, 
    ...
    public static Specification<TSource> Not<TSource>(
        this ISpecification<TSource> specification)
        => new SpecificationNot<TSource>(specification);

    /// <summary>
    /// Returns a boolean value that determines whether 
    /// or not the source satisfied to the specified specification.
    ...
    /// if specification is satisfied, otherwise <see langword="false"/>.</returns>
    public static bool SatisfiesTo<TSource>(
        this TSource source,
    ...
    /// <summary>
    /// Returns a boolean value that determines whether 
    /// or not the collection of items satisfy to the.
    /// If so, returns <see langword="true"/>, otherwise <see langword="false"/>.
    /// </summary>
    /// <typeparam name="TSource">The type of the object to check for.</typeparam>
    /// <param name="sources">The collection of items to check for.</param>
    /// <param name="specification">The specification to be applied.</param>
    /// <returns><see langword="true"/> if specification is satisfied by all 
    /// items, otherwise <see langword="false"/>.</returns>
    public static bool SatisfyTo<TSource>(
